...
\begin{center}
{\bf CSE 3320.001 Operating Systems \linebreak{} Spring 2025\linebreak{} \ \
}
\end{center}
...
\noindent\textbf{Section Information:} CSE3320 Section 001
 \vskip.25in
\noindent\textbf{Time and Place of Class Meetings}:  MW 7:00PM - 8:20 PM WH 404
\vskip.25in
...
\vskip.25in
\noindent\textbf{Descriptions of major assignments}: There will be two exams plus a final exam.  There will be approximately 4 programming assignments and 2-4 homework assignments.  Quizzes may be given as needed. 
 Programming assignments, and any homework assignments are not considered major works. All dates will be posted in advance on the course Canvas site.  The final exam date is set by the university and is non-negotiable.
\vskip.25in
%\pagebreak
\noindent\textbf{Important Dates}:
\begin{center} \begin{minipage}{5in}
\begin{flushleft}
Drop Deadline \dotfill Apr. 4th\\
Exam 1 \dotfill (tentative date)\\
Exam 2 \dotfill (tentative date)\\
Final  \dotfill May 5th 8:15pm - 10:45pm (firm date)\\
\end{flushleft}
\end{minipage}
\end{center}
\vskip.25in
